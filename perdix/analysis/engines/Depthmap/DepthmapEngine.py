<<<<<<< HEAD:esstoolkit/analysis/engines/Depthmap/DepthmapEngine.py
# -*- coding: utf-8 -*-
...
>>>>>>> a9f7ff0 (Rename project, fix licenses, add new depthmapXcli):perdix/analysis/engines/Depthmap/DepthmapEngine.py
