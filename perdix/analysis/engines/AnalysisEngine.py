...
class AnalysisEngine:
    ...
    def is_valid_unlinks_layer(self, unlinks_layer):
        return (
            lfh.fieldExists(unlinks_layer, "line1")
            and lfh.fieldExists(unlinks_layer, "line2")
            and not lfh.fieldHasNullValues(unlinks_layer, "line1")
            and not lfh.fieldHasNullValues(unlinks_layer, "line2")
        )
